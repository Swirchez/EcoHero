...
quizzes = { 
    "Новичок 🌱": [
        ...
        {
            "question": "Что следует сделать с батарейками после использования?",
            "options": ["Выбросить в мусор", "Сжечь", "Закопать", "Сдать в пункт приёма"],
            "answer": 3
        },
        {
            "question": "Какой мусор можно компостировать?",
            "options": ["Огрызок яблока", "Пластиковая крышка", "Фольга", "Стекло"],
            "answer": 0
        },
        {
            "question": "Что означает значок с тремя стрелками в форме треугольника?",
            "options": ["Опасный отход", "Мусор", "Переработка", "Запрещено"],
            "answer": 2
        },
        {
            "question": "Чем лучше заменить пластиковые пакеты?",
            "options": ["Бумажными", "Тканевыми сумками", "Фольгой", "Стеклянной банкой"],
            "answer": 1
        },
        {
            "question": "Что из этого можно сдать в макулатуру?",
            "options": ["Старые газеты", "Картонные коробки", "Журналы", "Всё вышеперечисленное"],
            "answer": 3
        }
    ],
    "Любитель 🌿": [
        ...
        {
            "question": "Что помогает сократить углеродный след дома?",
            "options": ["Использование кондиционера", "Энергосберегающие лампы", "Долгое принятие душа", "Бензогенератор"],
            "answer": 1
        },
        {
            "question": "Какой бытовой прибор потребляет больше всего электроэнергии?",
            "options": ["Холодильник", "Телевизор", "Фен", "Электрическая плита"],
            "answer": 3
        },
        {
            "question": "Чем отличается органический продукт?",
            "options": ["Он дешевле", "Произведён без химикатов", "Содержит больше сахара", "Упакован в пластик"],
            "answer": 1
        },
        {
            "question": "Как можно снизить количество пластиковых отходов?",
            "options": ["Покупать бутилированную воду", "Использовать одноразовую посуду", "Отказаться от упаковки", "Больше покупать"],
            "answer": 2
        },
        {
            "question": "Что такое углеродный след?",
            "options": ["Следы шин на дороге", "Объём выбросов CO2, связанных с деятельностью человека", "След от загрязнения воды", "Отметка о переработке"],
            "answer": 1
        }
    ],
    "Эксперт 🌳": [
        ...
        {
            "question": "Что такое концепция «нулевых отходов» (Zero Waste)?",
            "options": ["Сжигание всех отходов", "Полное устранение мусора путём переработки и повторного использования", "Запрет на упаковку", "Создание мусора с последующей нейтрализацией"],
            "answer": 1
        },
        {
            "question": "Какая из этих технологий помогает улавливать CO2 из атмосферы?",
            "options": ["Гидроэнергетика", "Угольные фильтры", "Direct Air Capture", "Ядерные реакторы"],
            "answer": 2
        },
        {
            "question": "Какие отходы считаются опасными?",
            "options": ["Пищевые отходы", "Газеты", "Батарейки и лампы", "Пластиковые пакеты"],
            "answer": 2
        },
        {
            "question": "Какой экологический термин обозначает воздействие продукта на природу на всех этапах жизни?",
            "options": ["Биодеградация", "Углеродный след", "Жизненный цикл", "Токсичность"],
            "answer": 2
        },
        {
            "question": "Что делает зелёную экономику устойчивой?",
            "options": ["Рост добычи ископаемых", "Инвестиции в ВИЭ и переработку", "Увеличение экспорта", "Снижение налогов"],
            "answer": 1
        }
    ]
}
...
def set_rank(message):
    ...
    bot.send_message(
        message.chat.id,
        "Твой ранг: " + rank + ". Нажми '🎯 Викторина' для получения вопроса за который дадут ЭкоБаллы, ты всегда можешь посмотреть свои данные - нажав на кнопку '📊 Статистика' и ты всегда можешь зайти в '🏬 Магазин' - где можно либо купить промокод за 45 ЭкоБаллов, либо активировать ВИП-статус за 150 ЭкоБаллов. Удачи!"
    )
